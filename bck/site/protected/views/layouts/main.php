...
<div class="container" id="page">
    ...
    <div><a href="#"><img src="/images/logo_opera_mini.png" alt="Logo" class="logo_mini"></a></div>
        <div class="copyright">Copyright © 2010 - 2014 ООО "Свит Дрим Украина"<br>
